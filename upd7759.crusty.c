...
XXX slave mode is still some what of a mystery.  Everything
XXX we know about slave mode (and 1/2 of everything in master
XXX mode) is from guesswork. As far as we know the clock rate
